...
<body>
    ...
    <main>
        <section class="meu_perfil">
            <div class="perfil">
                    <div class="perfil-foto">EX</div>
                    <div class="perfil-info">
                        <h2 class="perfil-nome">Exemplo Usuário</h2>
                        <p class="perfil-email">exemplo@email.com</p>
                    </div>
                </div>
            <section class="cartoes_perfil">
                <div class="cartao">
                    <div class="cartao_info">
                        <div>
                            <img class="cartao_img" src="../../../imagens/icones/perfil_icon/informacao_perfil_icon.png" alt="" width="24" height="24">
                        </div>
                        <div>
                            <section class="cartao_titulo">                   
                                    <span>Informações pessoais</span>
                            </section>
                            <section class="cartao_texto">
                                    <span>Informações do seu documento de identidade e sua atividade econômica.</span>
                            </section>
                        </div>
                ...
                <div class="cartao">
                    <div class="cartao_info">
                        <div>
                            <img class="cartao_img" src="../../../imagens/icones/perfil_icon/dados_perfil_icon.png" alt="" width="24" height="24">
                        </div>
                        <div>
                            <section class="cartao_titulo">                   
                            ...
                            <section class="cartao_texto">
                                    <span>Dados que representam a conta no Mercado Livre e Mercado Pago.</span>
                ...
                <div class="cartao">
                    <div class="cartao_info">
                        <div>
                            <img class="cartao_img" src="../../../imagens/icones/perfil_icon/seguranca_perfil_icon.png" alt="" width="24" height="24">
                        </div>
                        <div>
                            <section class="cartao_titulo">                   
                                    <span>Segurança</span>
                            ...
                            <section class="cartao_texto">
                                    <span>Você configurou a segurança da sua conta.</span>
                            </section>
                        </div>
                    </div>    
                </div>
                <div class="cartao">
                    <div class="cartao_info">
                        <div>
                            <img class="cartao_img" src="../../../imagens/icones/perfil_icon/propaganda_perfil_icon.png" alt="" width="24" height="24">
                        </div>
                        <div>
                            <section class="cartao_titulo">                   
                                    <span>Meli+</span>
                            ...
                            <section class="cartao_texto">
                                    <span>Assinatura com benefícios em compras e entretenimento.</span>
                            </section>
                        </div>
                    </div>
                </div>
                <div class="cartao">
                    <div class="cartao_info">
                        <div>
                            <img class="cartao_img" src="../../../imagens/icones/perfil_icon/cartao_perfil_icon.png" alt="" width="24" height="24">
                        </div>
                        <div>
                                <section class="cartao_titulo">                   
                                        <span>Cartões</span>
                                ...
                                <section class="cartao_texto">
                                        <span>Cartões salvos na sua conta.</span>
                                </section>
                        </div>
                    </div>
                </div>
                <div class="cartao">
                    <div class="cartao_info">
                        <div>
                            <img class="cartao_img" src="../../../imagens/icones/perfil_icon/endereco_perfil_icon.png" alt="" width="24" height="24">
                        </div>
                        <div>
                                <section class="cartao_titulo">                   
                                        <span>Endereços</span>
                                ...
                                <section class="cartao_texto">
                                        <span>Endereços salvos na sua conta.</span>
                                </section>
                        </div> 
                    </div>
                </div>
                <div class="cartao">
                    <div class="cartao_info">
                        <div>
                            <img class="cartao_img" src="../../../imagens/icones/perfil_icon/privacidade_perfil_icon.png" alt="" width="24" height="24">
                        </div>
                        <div>
                                <section class="cartao_titulo">                   
                                ...
                                <section class="cartao_texto">
                                        <span>Preferências e controle do uso dos seus dados.</span>
                                </section>
                        </div>
                    </div>
                </div>
                <div class="cartao">
                    <div class="cartao_info">
                        <div>
                            <img class="cartao_img" src="../../../imagens/icones/perfil_icon/comunicacao_perfil_icon.png" alt="" width="24" height="24">
                        </div>
                        <div>
                                <section class="cartao_titulo">                   
                                ...
                                <section class="cartao_texto">
                                        <span>Escolha que tipo de informação você quer receber.</span>
                                </section>
                        </div>
                    </div>  
                </div>
            </section>
            <section class="cancelar_perfil">
                <div>
                    <span>Você pode <a href="#">cancelar sua conta</a> quando quiser.</span>
                </div>
            </section>
        </section>
    </main>
    <aside>
        <div class="barra_lateral">
            ...
            <ul>
                ...
                <li>
                    <img src="../../../imagens/icones/anuncios_icon/vendas_icon.png" alt="">
